...
export default function SearchPage() {
  ...
  // Get initial query from URL (?q=...) or default to empty
  ...
  // Sync URL with Query (so you can share search links)
  useEffect(() => {
    if (query) {
        ...
        {results.map((result) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <Link 
                // IF it's a Post, link to parent and open the accordion. IF Entity, just go there.
            ...
            {/* Render the snippet with bold highlights provided by Postgres */}
            <div 
